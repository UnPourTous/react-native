...
const checkImageSource = require('./examples/Accessibility/check.png');
const uncheckImageSource = require('./examples/Accessibility/uncheck.png');
const mixedCheckboxImageSource = require('./examples/Accessibility/mixed.png');
